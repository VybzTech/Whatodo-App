...
class EditSub extends StatefulWidget {
  final List<String> list;
  const EditSub({Key? key, required this.list}) : super(key: key);

  @override
  State<EditSub> createState() => _EditSubState();
}

class _EditSubState extends State<EditSub> {
  @override
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Column(children: [
            Container(
                ...
                height: widget.list.isEmpty ? 50 : widget.list.length * 40,
                child: widget.list.isEmpty
                    ? MontText(
                        text: 'There are no Subtasks in this Todo',
        ...
        Padding(
            ...
            child: Row(
                ...
                children: [
                  ...
                  Icon(
                    useIcon(MdiIcons.deleteVariant, Icons.delete_rounded),
                    size: M + 1.5,
